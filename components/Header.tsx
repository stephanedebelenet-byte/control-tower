  ...
  return (
    <header className="bg-slate-950 border-b border-slate-700 px-6 py-4">
      ...
      <nav className="flex gap-6 text-sm border-t border-slate-700 pt-3">
        ...
        <Link href="/fuel" className={`transition ${isActive('/fuel')}`}>
          Fuel
        </Link>
        <Link href="/maintenance" className={`transition ${isActive('/maintenance')}`}>
          Maintenance
        </Link>
        <Link href="/analytics" className={`transition ${isActive('/analytics')}`}>
          Analytics
        </Link>
        ...
        <Link href="/sensors" className={`transition ${isActive('/sensors')}`}>
          Sensors
        </Link>
      </nav>
    </header>
